...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('fourf'):
        return None
    ...
    return f"https://github.com//fourf/blob/master/src/{filename}.py#L{lineno}"
...
html_theme_options = {
    ...
    "package_docs"    : "https://.github.io/fourf/",
    "package_repo"    : "https://github.com//fourf",
    "package_old_versions_txt": "https://.github.io/fourf/doc_versions.txt"
}
